...
CDXLTokens::Init(CMemoryPool *mp)
{
	...
	SWszMapElem rgStrMap[] = {
		...
		{EdxltokenIndexKeyColsSortOrder, GPOS_WSZ_LIT("SortDirection")},
		{EdxltokenIndexKeyColsNullsOrder, GPOS_WSZ_LIT("NullsDirection")},
		{EdxltokenIndexKeyColSortASC, GPOS_WSZ_LIT("ASC")},
		{EdxltokenIndexKeyColSortDESC, GPOS_WSZ_LIT("DESC")},
		{EdxltokenIndexKeyColNullFirst, GPOS_WSZ_LIT("FIRST")},
		{EdxltokenIndexKeyColNullLast, GPOS_WSZ_LIT("LAST")},
