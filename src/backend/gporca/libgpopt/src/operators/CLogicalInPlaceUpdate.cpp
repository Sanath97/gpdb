...
//
//---------------------------------------------------------------------------
CLogicalInPlaceUpdate::CLogicalInPlaceUpdate(CMemoryPool *mp, CTableDescriptor *ptabdesc,
											 CColRefArray *pdrgpcrInsert, CColRefArray *pdrgpcrDelete,
											 CColRef *pcrCtid,
...
//---------------------------------------------------------------------------
COperator *
CLogicalInPlaceUpdate::PopCopyWithRemappedColumns(CMemoryPool *mp,
												  ...
												  BOOL must_exist)
{
	...
	return GPOS_NEW(mp)
		CLogicalInPlaceUpdate(mp, m_ptabdesc, pdrgpcrInsert, pdrgpcrDelete, pcrCtid,
							  pcrSegmentId);
}
